const recipes = [
  ...
  },
  {
    ...
    time: 15,
    description:
      "Peler le concombre le couper 2, retirer le pépins. Couper les olives en morceaux, ainsi que le fromage de chèvre. Ajouter le basilic ainsi que le vinaigre balsamic et l'huile d'olives à votre gout.",
    appliance: "Saladier",
